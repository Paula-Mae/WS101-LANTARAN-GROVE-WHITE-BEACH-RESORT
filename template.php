...
<!--         <div class="search_button">
  ...
  <div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images\img3.jpg" data-speed="0.8"></div>
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Book Your Stay</h1></div>
      <div class="home_text text-center">Welcome to Lantaran Grove White Beach Resort, where the sand is pristine and the experience is unforgettable. Our brand-new Online Reservation and Scheduling System is designed for your convenience, allowing you to easily check room availability, book your preferred dates, and plan your escape to paradise in just minutes. Dive into relaxation—your perfect beach vacation awaits!</div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>CATARMAN NORTHERN SAMAR</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Paopao</a>
